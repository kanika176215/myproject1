...
const Slide4 = () => {
    ...
    <div className="bg-black text-white relative">
        ...
        <div className="h-24 text-white text-center pt-5 font-bold text-[20px]  border-b-[1px] border-white mx-4 relative  ">
            UNICIA TRAILS
        </div>
            ...
            <div className="mx-4 my-8 font-bold ">
               Navigate
        ...
        <div className="mx-4 my-8 font-bold border-b pb-4 ">
               Address
   ...
   <div className=" relative h-32 text-white  text-[20px]  border-white mx-4">
